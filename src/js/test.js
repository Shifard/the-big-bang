const questions = [
    // easy
    {
      ...
      choices: ["Supernova", "Big Bang", "Black Hole Explosion", "Cosmic Storm"],
  ...
  function checkAnswer(selectedAnswer, selectedBtn) {
    ...
    if (selectedAnswer === current.correctAnswer) {
      selectedBtn.style.cssText = "background-color: var(--green)";
      score++;
    } else {
      selectedBtn.style.cssText = "background-color: var(--red)";
    }
